...
/** ============================================================================
    ...
    @details   This constant sets the default alignment boundary (in bytes) 
               for all memory allocations.nProper alignment ensures optimal 
               performance and adherence to architecture-specific
...
/** ============================================================================
    ...
    @details   This set of preprocessor directives detects the target 
               architecture and sets the ARCH_ALIGNMENT macro accordingly. 
               Proper alignment ensures optimal memory access
               performance and adherence to architecture-specific requirements.
    
    @note      - x86_64 and ARM64 architectures typically benefit from 
                 16-byte alignment.
...
/** ============================================================================
    ...
    @details   This macro takes a size and rounds it up to the nearest multiple
               of ALIGNMENT. It ensures that memory allocations are properly
               aligned, which is crucial for performance and preventing
...
/** ============================================================================
    ...
    @details   Specifies the different algorithms that can be used 
...
/** ============================================================================
    ...
    @details   This structure contains metadata about each memory block, 
               including its size, allocation status, pointers to adjacent 
               blocks, and debug information.
============================================================================ **/
...
/** ============================================================================
    ...
    @details   This structure maintains the free list, the heap's starting 
               address, and the last allocated block for Next-Fit allocation.
============================================================================ **/
...
/** ============================================================================
  ...
  @details Formats and prints debug messages to the standard output using 
           variable arguments.
...
/** ============================================================================
  ...
  @param   [in/out] allocator Pointer to the memory allocator structure to 
                    be initialized.
...
/** ============================================================================
  ...
  @details Checks whether a given pointer falls within the allocator's 
           heap range, is properly aligned,
...
/** ============================================================================
  ...
  @details Implements the First-Fit allocation strategy by searching the free 
           list and returning the first block that is large enough to satisfy
...
/** ============================================================================
  ...
  @brief   Finds the next suitable free block starting from the last 
           allocated block.

  @details Implements the Next-Fit allocation strategy by continuing the search 
           from where the last allocation occurred, potentially improving 
           allocation distribution and reducing fragmentation.
...
/** ============================================================================
  ...
  @details Implements the Best-Fit allocation strategy by searching the 
           free list and selecting the smallest block that is large enough 
           to satisfy the allocation request, aiming to minimize fragmentation.
...
/** ============================================================================
  ...
  @details Divides a larger free block into an allocated block and a smaller 
           free block while maintaining alignment constraints. Updates
...
/** ============================================================================
  ...
  @details Combines a free block with its neighboring free blocks (if any) 
           to create a larger contiguous free block. Updates the free 
           list accordingly.
...
/** ============================================================================
  ...
  @details Allocates a block of memory of the specified size from the 
           allocator's heap. It aligns the size, selects the allocation
           strategy, finds the appropriate-fit block, splits it if necessary,
           and updates the block's metadata with the allocation source 
           information.
...
/** ============================================================================
  ...
  @details Marks a previously allocated block as free, clears its metadata, 
           and attempts to merge it with adjacent free blocks to minimize 
           fragmentation.
...
/** ============================================================================
  ...
  @details Iterates through the heap and prints the status of each memory 
           block, including its address, size, allocation status, and the
           source file and line number if allocated.
...
/** ============================================================================
    ...
    @brief     Allocates memory using the custom allocator with file and 
               line information.
    
    @details   This macro simplifies memory allocation by automatically 
               passing the current file name and line number
...
/** ============================================================================
    ...
    @details   This macro allocates memory using the First-Fit allocation 
               strategy by automatically passing the current file name and 
               line number to the allocator, aiding in debugging.
...
/** ============================================================================
    ...
    @details   This macro allocates memory using the Next-Fit allocation 
               strategy by automatically passing the current file name and 
               line number to the allocator, aiding in debugging.
...
/** ============================================================================
    ...
    @details   This macro allocates memory using the Best-Fit allocation 
               strategy by automatically passing the current file name and 
               line number to the allocator, aiding in debugging.
...
/** ============================================================================
    ...
    @brief     Frees allocated memory using the custom allocator with 
               file and line information.
    
    @details   This macro simplifies memory deallocation by automatically 
               passing the current file name and line number
               to the allocator, aiding in debugging.
