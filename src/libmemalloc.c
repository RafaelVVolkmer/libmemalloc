/** ===========================================================================
    ...
    @details    
                ...
                The module ensures proper memory alignment based on
                the target architecture, enhancing performance and 
                compatibility. Additionally, it includes debugging featureS
                that track allocation sources, facilitating easier debugging
                and memory management.
    
    @note       
                - Ensure that the allocator is initialized before 
                performing any allocation or deallocation.
...
/** ============================================================================
  ...
  @details Ensures that the heap is properly aligned based on the architecture
