...
<img
    src="/assets/images/libmemalloc_reviewing.svg"
...
Review the rationale, alternatives and verification evidence in the issue or pull request using the
[engineering review procedure](docs/procedures/decision-making.md).
Check that the observations support the claimed behavior and identify untested assumptions.
